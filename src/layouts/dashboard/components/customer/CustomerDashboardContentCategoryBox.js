...
const CustomerDashboardContentCategoryBox = ({ category }) => {
	return (
		<div className="p-4 rounded-2xl bg-[#d4cbed] flex flex-col justify-center items-center gap-4 cursor-pointer">
			...
			<h3 className="text-lg text-main-primary font-sansation-bold text-center capitalize">{category.title}</h3>
		</div>
	)
}
